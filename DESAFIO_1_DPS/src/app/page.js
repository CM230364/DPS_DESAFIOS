"use client"; // Esta directiva debe ser la primera línea del archivo
...
export default function Home() {
  ...
  // Esta función es usada por ambos botones "Borrar" y "Reiniciar"
  const clearInputs = () => {
    setNumero1('');
    setNumero2('');
    setResultado(null);
  ...
  const calculate = (operation) => {
    ...
    // Validación específica para Raíz Cuadrada (solo requiere numero1)
    ...
    switch (operation) {
      case 'sumar':
        ...
        break;
      case 'restar': // <-- ¡Este botón se mantiene!
        res = num1 - num2;
  ...
  return (
    <main className={styles.main}>
      <div className={styles.calculadora}>
        ...
        {/* Contenedor para los botones de operación (solo operaciones matemáticas) */}
        ...
        {/* Contenedor para los botones "Borrar" y "Reiniciar" (abajo y separados) */}
